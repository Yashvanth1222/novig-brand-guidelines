// ============================================================
//  YOUTUBE SHORTS SAFE ZONE OVERLAY — Novig Brand Tool
//  Color: Red (#FF2D2D)
//  Canvas: 1080 × 1920 px
//
//  Safe zone margins — OFFICIAL GOOGLE SOURCE (support.google.com/google-ads):
//    Top    288px — Channel name, subscriber count, progress bar
//    Bottom 672px — Description text, Like / Dislike, Comments button
//    Left    48px — General screen edge margin
//    Right  192px — Like / Dislike / Comment / Share / Remix buttons
//
//  ✅ Values taken directly from Google's official vertical video ads
//     safe zone diagram (support.google.com/google-ads/answer/9128498).
//     Safe area: 840×960px
//
//  Source: support.google.com/google-ads (official)
// ============================================================
#target photoshop

(function () {

    var PLATFORM   = "YouTube Shorts";
    var TOP        = 288;   // official: support.google.com/google-ads/answer/9128498
    var BOTTOM     = 672;   // official: support.google.com/google-ads/answer/9128498
    var LEFT       = 48;    // official: support.google.com/google-ads/answer/9128498
    var RIGHT      = 192;   // official: support.google.com/google-ads/answer/9128498
    var COLOR      = [255, 45, 45];     // YouTube red
    var COLOR_FILL = [255, 80, 80];
    var FILL_ALPHA = 30;

    var UI = {
        top:    "Channel name · Subscribers · Progress bar",
        bottom: "Description · Like / Dislike · Comments · Share",
        right:  "Like · Dislike · Comment · Share · Remix buttons"
    };
    ...
    grp.name = "▶ YouTube Shorts Safe Zone  ▲" + TOP + " ▼" + BOTTOM + " ◀" + RIGHT + " ▶" + LEFT;
    ...
    addTextLabel(doc, grp, SX + 14, SY + SH / 2,
        "◀ " + RIGHT + "px from right  |  " + UI.right, COLOR, 18);
    addTextLabel(doc, grp, SX + 14, SY + 68,
        PLATFORM + " Safe Zone  —  " + SW + "×" + SH + "px clear area", COLOR, 22);

    app.preferences.rulerUnits = orig;
    alert("YouTube Shorts Safe Zone overlay added ✓\n\nTop:    " + TOP + "px\nBottom: " + BOTTOM + "px\nLeft:   " + LEFT + "px\nRight:  " + RIGHT + "px\nSafe area: " + SW + "×" + SH + "px\n\nSource: support.google.com/google-ads/answer/9128498\n(Official Google vertical video ads spec)");
